...
# keras67_mnist_hist.py from kears54.py
...
hist = model.fit(x_train,y_train, epochs= 1, batch_size= 120, validation_split= 0.25 ,callbacks= [early_stopping])
