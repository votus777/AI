...
model.add(Flatten())                                            #  Dense 모델에 넣기 위해 4차원 텐서의 차원을 쫙 펴서 낯추자 -> Flattten 
...
_________________________________________________________________
conv2d_3 (Conv2D)            (None, 2, 2, 10)           405   ((kernel_size)*stride+1)*filters)
...
_________________________________________________________________
                  ...
                  ____________padding = 'same'_______________
_________________________________________________________________
Layer (type)                 Output Shape              Param #   
conv2d_1 (Conv2D)            (None, 10, 10, 10)        50        
_________________________________________________________________
conv2d_2 (Conv2D)            (None, 10, 10, 10)        820
_________________________________________________________________
conv2d_3 (Conv2D)            (None, 10, 10, 10)         405
=================================================================
Total params: 1,275
...
※ Maxpooling ->  pool_size ( n, n ) , 특성 중에 가장 좋은 것을 추출한다 
