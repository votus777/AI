...
x_n = x_n.reshape(442,4,1)
x_p = x_p.reshape(442,4,1)
...
#model -------- 1
input1 = Input(shape=(4,1 ), name= 'input_n') 

dense1_1 = LSTM(240, activation= 'relu', name= '1_1') (input1) 
dense1_2 = Dense(12,activation='relu', name = '1_2')(dense1_1)
dense1_3 = Dense(25,activation='relu', name = '1_3')(dense1_2)


#model -------- 2
input2 = Input(shape=(4,1 ), name = 'input_p') 

dense2_1 = LSTM(240, activation= 'relu', name = '2_1')(input1) 
dense2_2 = Dense(12,activation='relu', name = '2_2')(dense2_1)
dense2_3 = Dense(25,activation='relu', name = '2_3')(dense2_2)
...
middle1 = Dense(12, activation= 'relu')(merge1)
middle1 = Dense(12, activation= 'relu')(middle1)


################# output 모델 구성 ####################


output1 = Dense  (5, activation= 'relu',name = 'output_1')(middle1)
output1_2 = Dense (6, activation= 'relu',name = 'output_1_2')(output1)
output1_3 = Dense (12, activation= 'relu',name = 'output_1_3')(output1_2)
...
hist = model.fit([x_n,x_p],y, epochs= 10000, batch_size= 2, validation_split= 0.2,  callbacks= [early_stopping])
