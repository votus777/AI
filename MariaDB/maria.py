...
# DML(Data Manipulation Language, 데이터 조작어)의 insert, update, delete를 처리하는 함수
...
try:
    ...
    sql="SELECT name,phone, birth,skey,pnum FROM smember ORDER BY id ASC"
    ...
    for item in resultList:
        ...
        skey=item[3] # 학생학원출석4자리숫자

        

        info = u"이름:{}, 핸드폰 :{}, 출석키 :{}".format(name, phone, skey)
