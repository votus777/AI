...
# train[src_columns] = train_src.interpolate(axis=1)
# train[dst_columns] = train_dst.interpolate(axis=1)

# test[dst_columns] = test_dst.interpolate(axis=1)
# test[src_columns] = test_src.interpolate(axis=1)
...
#model -------- 1
input1 = Input(shape=(35, ), name= 'input_1') 

x1 = Dense(24, activation= 'relu', name= '1_1') (input1) 
x1 = Dense(12,activation='relu', name = '1_2')(x1)



#model -------- 2
input2 = Input(shape=(35, ), name = 'input_2') 

x2 = Dense(24, activation= 'relu', name = '2_1')(input2) 
x2 = Dense(12,activation='relu', name = '2_2')(x2)
...
x3 = Dense  (8,activation='relu',name = 'output_1')(middle1)
x3 = Dense (8,activation='relu', name = 'output_1_3')(x3)
